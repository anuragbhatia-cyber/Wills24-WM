...
import { TeamManagement } from '@/sections/team-management/components/TeamManagement'
import type { TeamManagementProps } from '@/../product/sections/team-management/types'
